...
pub struct KeyActionT {
    what: u32, //enum { KEYPRESS, KEYRELEASE },
    keycode: u32,
}
...
pub unsafe fn ps2_new() {
    //clock_gpio: u8, data_gpio: u8) -> Ps2DeviceT {
    /*
        let dev = Ps2DeviceT {
