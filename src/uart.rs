...
static mut UART: *mut UART =
MINI_UART_BASE as u32 as *mut UART as *mut UART;
...
pub unsafe extern "C" fn uart_init() {
    ...
    *aux |= AUX_ENABLE as u32; 
    ...
    core::ptr::write_volatile(&mut (*UART).iir as *mut u32, (MINI_UART_IIR_RX_FIFO_CLEAR | 
    ...
    core::ptr::write_volatile(&mut (*UART).cntl as *mut u32, (MINI_UART_CNTL_TX_ENABLE | 
                                                                     MINI_UART_CNTL_TX_ENABLE) 
                                                                     as u32);
}
...
#[no_mangle]
pub unsafe extern fn put_char(ch: u8) -> u8{
...
#[no_mangle]
pub unsafe extern fn put_string(str: *const u8) -> u32 {
    let mut n: u32= 0;
